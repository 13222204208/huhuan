...
type HelpWork struct {
	global.GVA_MODEL
	OrderNum     string  `json:"orderNum" form:"orderNum" gorm:"column:order_num;comment:订单号;size:18;"`
	Contents     string  `json:"contents" form:"contents" gorm:"column:contents;comment:事务详情;"`
	...
	Time         string  `json:"time" form:"time" gorm:"column:time;comment:帮忙时间;"`
	HelpTime     string  `json:"help" form:"help" gorm:"column:help_time;comment:帮忙时长"`
	...
	EventType    string  `json:"eventType" form:"eventType" gorm:"event_type;comment:事件类型如遛狗"`
	...
	Status       int8    `json:"status" form:"status" gorm:"column:status;comment:订单的状态;size:2;default:0"`
	PayStatus    int8    `json:"payStatus" form:"payStatus" gorm:"column:pay_status;comment:订单的支付状态;default:0"`
